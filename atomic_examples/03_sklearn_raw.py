...
year_month = '2022-01'
raw_data_path = './data/green_tripdata_'+year_month+'.parquet' #./data/data_raw for full data (slower)
seme = 123
...
parameters = [{'n_estimators' : 10,'max_depth' : 1, 'random_state' : seme},
        {'n_estimators' : 20,'max_depth' : 2, 'random_state' : seme},
        {'n_estimators' : 10,'max_depth' : 5, 'random_state' : seme},
        ]
exp_name = year_month
